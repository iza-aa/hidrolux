...
export function BannerProduk2() {
  return (
    ...
    >
      ...
      <div className="absolute left-[35%] -bottom-10 w-40 h-40 rounded-full opacity-10" style={{ backgroundColor: "#D8D7DC" }} />

      {/* Header stripe — desktop only */}
      <div
        className="hidden md:flex absolute top-0 left-0 right-0 items-center px-14 gap-3 h-10"
      ...
      {/* Left: text */}
      <div className="relative z-10 flex-1 px-6 md:px-14 py-6 md:pt-12">
